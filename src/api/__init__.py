...
from src.api.english.word_category import router as wcategory_router
from src.api.english.word          import router as word_router
...
router.include_router(wcategory_router,    prefix="/api/v1/wcategory", tags=["Word category"], )
